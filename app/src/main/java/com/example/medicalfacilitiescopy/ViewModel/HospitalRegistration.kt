...
class HospitalRegistration : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val apiKey="YOUR API KEY HERE" //Get your API Key from here https://developers.google.com/maps/documentation/places/web-service/get-api-key
        ...
        findViewById<Button>(R.id.saveButton).setOnClickListener {
            ...
            if (place != null) {
                ...
                Toast.makeText(this, "Please select a Valid Hospital or Enter all the Fields", Toast.LENGTH_SHORT).show()
            }
        }
